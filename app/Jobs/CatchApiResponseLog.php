...
class CatchApiResponseLog  extends Job implements ShouldQueue
{
    ...
    public function infoLogger(){
        return CLogger::getLogger('api_response','webservice');
    }
    ...
    public function errorLogger(){
        return CLogger::getLogger('api_response_error','webservice');
    }
